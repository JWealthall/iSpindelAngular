...
@Component({
  selector: 'app-batch-end',
  templateUrl: './batch-end.component.html',
  styleUrls: ['./batch-end.component.css']
})
export class BatchEndComponent implements OnInit {
  batchId: Guid;
  batch: Batch;
  ...
  onSubmit() {
    this.batchService.endBatch(this.batchId, this.batch).subscribe(b => {
      this.batch = b;
